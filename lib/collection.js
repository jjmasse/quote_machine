...
DocumentData = new Meteor.Collection(null); // documents store references to their RowData
RowData = new Meteor.Collection(null); // collection containing the quote content for a document
